...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    /* Dash features */
    { "lqx",               "getgovernanceinfo",      &getgovernanceinfo,      {} },
    { "lqx",               "getsuperblockbudget",    &getsuperblockbudget,    {"index"} },
    { "lqx",               "gobject",                &gobject,                {} },
    { "lqx",               "voteraw",                &voteraw,                {"tx_hash","tx_index","gov_hash","signal","outcome","time","sig"} },
